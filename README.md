...
| vanilla-postgresql | anilla-postgresql-12.15.0<br>anilla-postgresql-14.7.0 | Vanilla-PostgreSQL is compatible with the native PostgreSQL kernel, enabling it to quickly provide HA solutions for various variants based on the native PostgreSQL kernel. | kizuna-lek |

...
| vanilla-postgresql | vanilla-postgresql-12.15.0<br>vanilla-postgresql-14.7.0<br>vanilla-postgresql-15.6.1138<br>vanilla-postgresql-15.7.0 | Vanilla-PostgreSQL is compatible with the native PostgreSQL kernel, enabling it to quickly provide HA solutions for various variants based on the native PostgreSQL kernel. | kizuna-lek |

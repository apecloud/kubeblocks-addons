...
JAVA_OPTS="-Xmx1024m -Xloggc:/opt/apache-doris/be/log/be.gc.log.${DATE} -Dsun.java.command=DorisBE -XX:-CriticalJNINatives"
{{- else if le $phy_memory 8589934592 }}
JAVA_OPTS="-Xmx2048m -Xloggc:/opt/apache-doris/be/log/be.gc.log.${DATE} -Dsun.java.command=DorisBE -XX:-CriticalJNINatives"
{{- else }}
JAVA_OPTS="-Xmx4096m -Xloggc:/opt/apache-doris/be/log/be.gc.log.${DATE} -Dsun.java.command=DorisBE -XX:-CriticalJNINatives"
{{- end}}
...
debug_inverted_index_compaction=false
...
disable_memory_gc=true
disable_pk_storage_page_cache=false
...
doris_enable_scanner_thread_pool_per_disk=true
...
enable_base_compaction_idle_sched=true
enable_brpc_stream_write_background=true
enable_column_type_check=true
...
enable_delete_when_cumu_compaction=false
enable_feature_binlog=false
enable_file_cache=false
enable_file_cache_query_limit=false
enable_file_logger=true
enable_flush_file_cache_async=true
enable_fuzzy_mode=false
enable_https=false
enable_inverted_index_cache_check_timestamp=true
enable_java_support=true
enable_je_purge_dirty_pages=true
enable_jvm_monitor=false
enable_low_cardinality_cache_code=true
enable_low_cardinality_optimize=true
enable_memory_orphan_check=true
enable_merge_on_write_correctness_check=true
enable_metric_calculator=true
enable_missing_rows_correctness_check=false
enable_ordered_data_compaction=true
enable_parquet_page_index=false
enable_pipeline_task_leakage_detect=false
enable_query_like_bloom_filter=true
enable_query_memory_overcommit=true
enable_rowid_conversion_correctness_check=false
enable_segcompaction=true
enable_set_in_bitmap_value=false
enable_shrink_memory=false
enable_simdjson_reader=true
enable_single_replica_load=true
enable_skip_tablet_compaction=true
enable_snapshot_action=false
enable_stream_load_record=false
enable_system_metrics=true
enable_time_lut=true
enable_token_check=true
enable_use_cgroup_memory_info=true
enable_vertical_compaction=true
enable_vertical_segment_writer=true
enable_workload_group_for_scan=false
enable_workload_group_memory_gc=true
enable_write_index_searcher_cache=true
es_http_timeout_ms=5000
es_scroll_keepalive=5m
estimated_mem_per_column_reader=1024
exchange_sink_ignore_eovercrowded=true
...
hide_webserver_config_page=false
...
inverted_index_compaction_enable=false
...
skip_loading_stale_rowset_meta=false
...
variant_throw_exeception_on_invalid_json=false

...
Describe "FalkorDB Cluster Replica Member Leave Bash Script Tests"
  # load the scripts to be tested and dependencies
  Include $common_library_file
  Include ../falkordb-cluster-scripts/falkordb-cluster-common.sh
  Include ../falkordb-cluster-scripts/falkordb-cluster-replica-member-leave.sh
...
#       setup() {
#         export CURRENT_SHARD_POD_FQDN_LIST="falkordb-shard-98x-0.namespace.svc.cluster.local,falkordb-shard-98x-1.namespace.svc.cluster.local"
#         export CURRENT_POD_NAME="falkordb-shard-98x-2"
#       }
#       Before "setup"
#
#       un_setup() {
...
#         The stderr should include "Error: Failed to get current pod: falkordb-shard-98x-2 fqdn from current shard pod fqdn list: falkordb-shard-98x-0.namespace.svc.cluster.local,falkordb-shard-98x-1.namespace.svc.cluster.local. Exiting."
#       End
#     End
    ...
    Context "when failed to get cluster nodes info"
      ...
      setup() {
        export CURRENT_SHARD_POD_FQDN_LIST="falkordb-shard-98x-0.namespace.svc.cluster.local,falkordb-shard-98x-1.namespace.svc.cluster.local"
        export CURRENT_POD_NAME="falkordb-shard-98x-1"
      }
      Before "setup"
    ...
    Context "when cluster nodes info contains only one line or is empty"
      get_cluster_nodes_info_with_retry() {
        echo "f7ed4469f3b90c790e0b482ce3843b3ee9fe4523 172.42.0.5:6379@16379,falkordb-shard-98x-1.falkordb-shard-98x-headless.default.svc myself,master - 0 1681966481000 0 connected"
        return 0
      }
    ...
    Context "when current node is a slave"
      get_cluster_nodes_info_with_retry() {
        echo "f7ed4469f3b90c790e0b482ce3843b3ee9fe4523 172.42.0.5:6379@16379,falkordb-shard-98x-1.falkordb-shard-98x-headless.default.svc myself,slave 172.42.0.4:6379 0 1681966481000 1 connected"$'\n'"c1ed4469f3b90c790e0b482ce3843b3ee9fe4524 172.42.0.4:6379@16379,falkordb-shard-98x-0.falkordb-shard-98x-headless.default.svc master - 0 1681966481000 2 connected 5461-10922"
        return 0
      }
      ...
      get_cluster_nodes_info() {
        echo "c1ed4469f3b90c790e0b482ce3843b3ee9fe4524 172.42.0.4:6379@16379,falkordb-shard-98x-0.falkordb-shard-98x-headless.default.svc master - 0 1681966481000 2 connected 5461-10922"
        return 0
      }
      ...
      It "returns 0 when successfully removed replica from the cluster"
        When call remove_replica_from_shard_if_need
        The status should be success
        The output should include "Current node falkordb-shard-98x-1 is a slave, removing it from the cluster..."
    ...
    Context "when current node is a master"
      ...
      setup() {
        export CURRENT_SHARD_POD_FQDN_LIST="falkordb-shard-98x-0.namespace.svc.cluster.local,falkordb-shard-98x-1.namespace.svc.cluster.local"
        export CURRENT_POD_NAME="falkordb-shard-98x-0"
      }
      Before "setup"
      ...
      It "returns 0 and does not remove current node from the cluster when it is a master"
        When call remove_replica_from_shard_if_need
        The status should be success
        The output should include "Current node falkordb-shard-98x-0 is a master, no need to remove it from the cluster."
      End
    End
  End
End
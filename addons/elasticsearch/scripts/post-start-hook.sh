...
index_name=kubeblocks_ca_pem
ca_pem=$(cat /usr/share/elasticsearch/config/ca.pem | base64 -w 0)
echo "fill elastic ca into index ${index_name}"
#{
#  "_index" : "kubeblocks_ca_pem",
#  "_id" : "1",
#  "_version" : 1,
#  "_seq_no" : 0,
#  "_primary_term" : 1,
#  "found" : true,
#  "_source" : {
#    "ca.pem" : ""
#  }
#}
...
curl ${COMMON_OPTIONS} -X POST -H "Content-Type: application/json" -d "{\"ca.pem\": \"${ca_pem}\"}" "${ENDPOINT}/${index_name}/_doc/1"

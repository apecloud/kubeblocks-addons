...
scale_redis_cluster_replica() {
  ...
  if ! is_rebuild_instance && check_node_in_cluster_with_retry "$primary_node_endpoint_for_meet" "$primary_node_port" "$current_node_host_info"; then
    ...
    primary_node_cluster_id=$(get_cluster_id_with_retry "$primary_node_endpoint_for_meet" "$primary_node_port") || primary_node_cluster_id_status=$?
    ...
    current_shard_node_ids=$(get_current_shard_node_ids "$primary_node_endpoint_for_meet" "$primary_node_port" "$primary_node_cluster_id") || current_shard_node_ids_status=$?
    ...
    ensure_current_node_replication "$primary_node_endpoint_for_meet" "$primary_node_port" "$primary_node_cluster_id" "$current_shard_node_ids" || current_node_replication_status=$?

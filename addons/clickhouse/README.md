...
- 1 ClickHouse Keeper instance for coordination (`ch-keeper` component using `ch-keeper-24` ComponentDef)
- 2 shards with 2 replicas each (total 4 ClickHouse server instances using `clickhouse-24` ComponentDef)

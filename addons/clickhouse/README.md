...
| 25             | 25.4.4, 25.9.7            |
| 26             | 26.3.33 (ClickHouse 26.3.33.24 LTS) |

Select `version=26.3.33` in the cluster chart to create a 26.3 cluster.
The default remains 25.9.7. In-place upgrades from earlier release lines to
26.3 are not supported by this addition.
...
spec:
  ...
  # standalone topology also uses shardings in ClusterDefinition
  shardings:
    - name: clickhouse
      shards: 1
      template:

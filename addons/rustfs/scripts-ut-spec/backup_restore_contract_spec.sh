...
Describe "RustFS backup/restore contract"
  It "backs up and restores through a certificate-verifying S3 client"
    ...
    The stderr should include "backup manifest contains invalid bucket name 192.168.1.1"
    The stderr should include "backup manifest contains invalid bucket name 1234.1.1.1"
    The stderr should include "backup manifest contains invalid bucket name rustfs"
    The stderr should include "backup manifest contains invalid bucket name aaa-.bbb"
    The stderr should include "backup manifest contains invalid bucket name aaa.-bbb"

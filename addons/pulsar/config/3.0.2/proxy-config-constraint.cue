...
// AUTO generate: ./bin/cue-tools https://raw.githubusercontent.com/apache/pulsar/v3.0.2/pulsar-proxy/src/main/java/org/apache/pulsar/proxy/server/ProxyConfiguration.java "ProxyConfiguration" "PulsarProxyParameter" > proxy-config-constraint.cue
...
#PulsarProxyParameter: {
	...
	enableProxyStatsEndpoints: bool

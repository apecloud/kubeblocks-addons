...
EOF
  ...
  Describe "alpha.65 v1 chart version bump for CmpD immutability"
    ...
    It "alpha.65 v1: Chart.yaml chart bump pattern from alpha.64 due to CmpD immutability — current bumped further to alpha.73 [contract-no-regression]"
      ...
      The status should be success
      The output should equal "version: 1.1.1-alpha.73"
    End
  ...
  Describe "alpha.66 v1 syncer HA executor + chart bump"
    ...
    Context "chart bump for CmpD immutability (per alpha.65 lesson)"
      It "alpha.66 v1: Chart.yaml chart bump pattern locked — current bumped to alpha.73 by alpha.73 v1 [contract-no-regression]"
  ...
  Describe "alpha.67 v1 ensure_internal_local_admin write-site zero-priv enforcement"
    ...
    Context "chart bump alpha.66 → alpha.67 → alpha.68 (CmpD immutability rule)"
      It "alpha.67 v1: Chart.yaml chart bump pattern locked — current bumped to alpha.73 by alpha.73 v1 [contract-no-regression]"

...
//9.0 and 9.1 (src/config.c) of https://github.com/valkey-io/valkey.
//
...
//
//One ComponentDefinition (valkey-9) serves both release lines, so this
//schema is the UNION of 9.0 and 9.1: a parameter that only exists in one of
...
#ValkeyParameter: {
    ...
    "cluster-announce-client-port"?: int | *0

    "cluster-announce-client-tls-port"?: int | *0
    ...
    // only in 9.1
    "cluster-config-save-behavior"?: string

    "cluster-databases"?: int | *1
    ...
    // only in 9.1
    "cluster-message-gossip-perc"?: int | *10
    ...
    "cluster-slot-migration-log-max-len"?: int | *1000

    "cluster-slot-stats-enabled"?: string & "yes" | "no" | *"no"

    // legacy alias: slowlog-log-slower-than
    ...
    // only in 9.1
    "io-threads-always-active"?: string & "yes" | "no" | *"no"
    ...
    "min-io-threads-avoid-copy-reply"?: int | *7
    ...
    "min-string-size-avoid-copy-reply"?: int | *16384

    "min-string-size-avoid-copy-reply-threaded"?: int | *65536

    "mptcp"?: string & "yes" | "no" | *"no"

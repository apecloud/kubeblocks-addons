...
{{- end }}
{{- define "oceanbase-hostnetwork.name" -}}
{{- printf "%s-hostnetwork" (default .Chart.Name .Values.nameOverride) | trunc 63 | trimSuffix "-" }}
{{- end }}
{{/*
...
{{- define "oceanbase-hostnetwork.labels" -}}
helm.sh/chart: {{ include "oceanbase.chart" . }}
{{ include "oceanbase-hostnetwork.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
{{- end }}
{{- define "oceanbase-hostnetwork.selectorLabels" -}}
app.kubernetes.io/name: {{ include "oceanbase-hostnetwork.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}

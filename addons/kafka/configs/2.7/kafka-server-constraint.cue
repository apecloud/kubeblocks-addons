...
// build from kafka:2.8.2 clients/src/main/java/org/apache/kafka/common/config/ConfigDef.java
#KafkaParameter: {
  ...
  // DEPRECATED: only used when <code>listeners</code> is not set. Use <code>listeners</code> instead.
  ...
  "quota.consumer.default"?: int & >=1 | *9223372036854775807
  ...
  "quota.producer.default"?: int & >=1 | *9223372036854775807
  ...
  "zookeeper.connection.timeout.ms"?: int | *6000
  ...
  "log.cleaner.min.cleanable.ratio"?: number | *0.5
  ...
  "zookeeper.clientCnxnSocket"?: string | *"org.apache.zookeeper.ClientCnxnSocketNetty"
  ...
  "zookeeper.ssl.cipher.suites"?: string | *"TLS_AES_256_GCM_SHA384"
  ...
  "zookeeper.ssl.enabled.protocols"?: string | *"TLSv1.2,TLSv1.3"
  ...
  "zookeeper.ssl.protocol"?: string | *"TLSv1.3"

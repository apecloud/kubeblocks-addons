...
#KafkaParameter: {
	...
	"zookeeper.connect"?: string // Example: "localhost:2181,localhost:2182"

	// The time in milliseconds that ZooKeeper will allow connections to remain idle before closing them.
	"zookeeper.session.timeout.ms"?: int & >= 1000 & <= 60000 

	// The maximum time that the client waits to establish a connection to ZooKeeper in milliseconds.
	"zookeeper.connection.timeout.ms"?: int & >= 1000 & <= 60000 

	// Determines whether to set ACLs (Access Control Lists) for ZooKeeper nodes.
	"zookeeper.set.acl"?: bool 

	// Maximum number of in-flight requests to ZooKeeper before a connection is considered stale.
	"zookeeper.max.in.flight.requests"?: int & > 0 

	// Enables or disables SSL for ZooKeeper client connections.
	"zookeeper.ssl.client.enable"?: bool // Default: false

	// The class name of the socket implementation for ZooKeeper client connections.
	"zookeeper.clientCnxnSocket"?: string // Example: "org.apache.zookeeper.ClientCnxnSocketNetty"

	// The file location of the SSL keystore used by the ZooKeeper client.
	"zookeeper.ssl.keystore.location"?: string

	// The password for the ZooKeeper client's SSL keystore.
	"zookeeper.ssl.keystore.password"?: string

	// The type of the ZooKeeper client's SSL keystore (e.g., JKS, PKCS12).
	"zookeeper.ssl.keystore.type"?: string // Example: "JKS"

	// The file location of the SSL truststore used by the ZooKeeper client.
	"zookeeper.ssl.truststore.location"?: string

	// The password for the ZooKeeper client's SSL truststore.
	"zookeeper.ssl.truststore.password"?: string

	// The type of the ZooKeeper client's SSL truststore (e.g., JKS, PKCS12).
	"zookeeper.ssl.truststore.type"?: string // Example: "JKS"

	// The SSL protocol used for ZooKeeper connections.
	"zookeeper.ssl.protocol"?: string // Default: "TLSv1.2"

	// The enabled SSL protocols for ZooKeeper connections, as a comma-separated list.
	"zookeeper.ssl.enabled.protocols"?: string

	// A list of SSL cipher suites to enable for ZooKeeper connections.
	"zookeeper.ssl.cipher.suites"?: string

	// The endpoint identification algorithm used for ZooKeeper SSL connections.
	"zookeeper.ssl.endpoint.identification.algorithm"?: string 

	// Whether Certificate Revocation List (CRL) checking is enabled for ZooKeeper SSL connections.
	"zookeeper.ssl.crl.enable"?: bool 

	// Whether Online Certificate Status Protocol (OCSP) checking is enabled for ZooKeeper SSL connections.
	"zookeeper.ssl.ocsp.enable"?: bool 

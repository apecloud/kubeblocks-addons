...
#ZookeeperParameter: {
	...
	// ZooKeeper configuration constraints

	// The port on which ZooKeeper listens for secure client connections.
	"secureClientPort"?: int & >= 1024 & <= 65535 // Example: 2182

	// The class name of the connection factory used by ZooKeeper to handle client connections.
	"serverCnxnFactory"?: string 

	// The X.509 authentication provider used for ZooKeeper server authentication.
	"authProvider.x509"?: string

	// The SASL authentication provider used for ZooKeeper server authentication.
	"authProvider.1"?: string 

	// The SSL protocol used by ZooKeeper server connections.
	"ssl.protocol"?: string  // Default: "TLSv1.2"

	// The enabled SSL protocols for ZooKeeper server connections, as a comma-separated list.
	"ssl.enabledProtocols"?: string  // Default: "TLSv1.2,TLSv1.3"

    ...
    exec:
      ...
      command:
        ...
        - |
          ...
          xtrabackup --compress=zstd --backup --safe-slave-backup --slave-info --stream=xbstream --host=${DB_HOST} --port=${DB_PORT} --user=${DB_
SER} --password=${DB_PASSWORD} --datadir=${DATA_DIR}
      targetPodSelector: Role
      matchingKey: leader
      container: mysql
  dataLoad:

...
assert_contains "${TMP_DIR}/hadoop-cluster.yaml" 'HDFS_JOURNALNODE_ENABLE_SYNC: "true"'
...
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-namenode.yaml" 'templateName: hdfs-common-config'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-namenode.yaml" 'templateName: namenode-config'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-namenode-standalone.yaml" 'componentDef: hdfs-namenode-standalone'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-namenode-standalone.yaml" 'templateName: hdfs-common-config'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-namenode-standalone.yaml" 'templateName: namenode-config'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-datanode.yaml" 'componentDef: hdfs-datanode'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-datanode.yaml" 'templateName: hdfs-common-config'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-datanode.yaml" 'templateName: datanode-config'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-datanode-standalone.yaml" 'componentDef: hdfs-datanode-standalone'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-datanode-standalone.yaml" 'templateName: hdfs-common-config'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-datanode-standalone.yaml" 'templateName: datanode-config'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-journalnode.yaml" 'componentDef: hdfs-journalnode'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-journalnode.yaml" 'templateName: hdfs-common-config'
assert_contains "${ROOT_DIR}/addons/hadoop/templates/pcr-hdfs-journalnode.yaml" 'templateName: journalnode-config'
...
assert_contains "${ROOT_DIR}/addons/hadoop/config/core-site.tpl" '$zkParentPrefix := .HDFS_HA_ZOOKEEPER_PARENT_ZNODE_PREFIX'
assert_not_contains "${ROOT_DIR}/addons/hadoop/config/core-site.tpl" 'default .HDFS_HA_ZOOKEEPER_PARENT_ZNODE'
...
assert_contains "${ROOT_DIR}/addons/hbase/config/hbase-site-standalone.tpl" 'hbase.unsafe.stream.capability.enforce'

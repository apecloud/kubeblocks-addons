...
```yaml
# cat examples/starrocks/cluster.yaml
...
```yaml
# cat examples/starrocks/scale-out.yaml
...
```yaml
# cat examples/starrocks/scale-in.yaml
apiVersion: operations.kubeblocks.io/v1alpha1
kind: OpsRequest
metadata:
  name: sr-scale-in
...
```yaml
# cat examples/starrocks/verticalscale.yaml
apiVersion: operations.kubeblocks.io/v1alpha1
kind: OpsRequest
metadata:
...
```yaml
# cat examples/starrocks/volumeexpand.yaml
apiVersion: operations.kubeblocks.io/v1alpha1
kind: OpsRequest
metadata:
...
```yaml
# cat examples/starrocks/restart.yaml
apiVersion: operations.kubeblocks.io/v1alpha1
kind: OpsRequest
metadata:
...
```yaml
# cat examples/starrocks/stop.yaml
apiVersion: operations.kubeblocks.io/v1alpha1
kind: OpsRequest
metadata:
  name: starrocks-stop
...
```yaml
# cat examples/starrocks/start.yaml
apiVersion: operations.kubeblocks.io/v1alpha1
kind: OpsRequest
metadata:
...
```yaml
# cat examples/starrocks/pod-monitor.yaml

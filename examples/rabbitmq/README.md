...
```bash
# get user name
kubectl get secrets rabbitmq-cluster-rabbitmq-account-root -o jsonpath='{.data.username}' | base64 -d
# get password
kubectl get secrets rabbitmq-cluster-rabbitmq-account-root -o jsonpath='{.data.password}' | base64 -d
```